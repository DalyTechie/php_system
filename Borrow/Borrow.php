...
<body>
    ...
    <div class="main-container">
        ...
        <div class="page-header">
            ...
            <div class="header-actions">
                ...
                <button type="button" class="btn btn-primary" onclick="openNewBorrowerModal()">
    ...
    <!-- New Borrower Modal -->
    <div id="newBorrowerModal" class="modal" style="display: none;">
        <div class="modal-content">
            <div class="modal-header">
                <h2>New Borrower</h2>
                <span class="close-btn" onclick="closeNewBorrowerModal()">&times;</span>
            </div>
            <form id="newBorrowerForm" method="POST" action="process_borrower.php">
                <div class="form-group">
                ...
                <div class="modal-buttons">
                    <button type="button" class="btn btn-secondary" onclick="closeNewBorrowerModal()">Cancel</button>
    ...
    <script>
        ...
        function closeNewBorrowerModal() {
            document.getElementById('newBorrowerModal').style.display = 'none';
        }

        // Close modal when clicking outside
        window.onclick = function(event) {
            var modal = document.getElementById('newBorrowerModal');
            if (event.target == modal) {
                closeNewBorrowerModal();
            }
        }
