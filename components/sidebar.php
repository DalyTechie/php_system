<aside class="w-64 h-screen fixed left-0 bg-white shadow-lg">
    ...
    <div class="p-6 border-b">
        ...
        <nav class="flex-1 p-4">
            ...
            <a href="user.php" class="flex items-center px-4 py-3 text-sm font-medium text-gray-600 hover:bg-gray-50 hover:text-indigo-600 rounded-lg mb-2 transition-colors duration-150">
                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
