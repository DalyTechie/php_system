<div class="menu-cards-container">
    ...
    <!-- Borrowers List Card -->
    <a href="Borrowers_List.php" class="menu-card blue">
        <div class="card-content">
            <div class="icon-wrapper">
                <svg class="card-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<div class="bg-white p-6 rounded-lg shadow-sm">
    ...
    <div class="flex space-x-4 mb-6 border-b">
        <a href="#revenue" onclick="return showSection('revenue')" class="nav-link active px-4 py-2 text-sm font-medium text-gray-600">
            Revenue Trend
        </a>
        <a href="#users" onclick="return showSection('users')" class="nav-link px-4 py-2 text-sm font-medium text-gray-600">
            User Growth
        </a>
        <a href="#orders" onclick="return showSection('orders')" class="nav-link px-4 py-2 text-sm font-medium text-gray-600">
            Order Trend
        </a>
    ...
    <div class="charts-container">
        <section id="revenue" class="chart-section active">
        ...
        <section id="users" class="chart-section hidden">
            <h3 class="text-lg font-medium text-gray-800 mb-4">User Growth</h3>
            <div class="h-[400px]">
                <canvas id="userGrowthChart"></canvas>
            </div>
        </section>

        <section id="orders" class="chart-section hidden">
            <h3 class="text-lg font-medium text-gray-800 mb-4">Order Trend</h3>
            <div class="h-[400px]">
        ...
        <section id="categories" class="chart-section hidden">
            <h3 class="text-lg font-medium text-gray-800 mb-4">Product Categories</h3>
            <div class="h-[400px]">
...
window.addEventListener('load', () => {
    const hash = window.location.hash.slice(1) || 'revenue';
    showSection(hash);
});
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const revenueTrendChart = new Chart(
