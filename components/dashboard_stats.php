<div class="stats-row flex justify-between items-center mb-8 bg-white p-6 rounded-lg shadow-sm border border-gray-100">
    ...
    <div class="flex items-center space-x-6">
        ...
        <div class="notification-icon relative group">
            ...
            <div class="absolute right-0 top-8 bg-gray-800 text-white text-xs px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity duration-200 whitespace-nowrap z-10" style="font-family: 'Khmer OS Siemreap', Arial, sans-serif;">
                ការជូនដំណឹង
            </div>
        </div>
